...
<div align="left" style="background-color: #252526; padding: 20px; border-radius: 15px; font-family: Consolas, 'Courier New', monospace; font-size: 13px; color: #CCCCCC; box-shadow: 0 8px 16px rgba(0,0,0,0.5); max-width: 650px; width: 85%; margin: 0 auto; line-height: 1.4; overflow-x: auto;">
  <div style="margin-bottom: 15px;">
    <span style="display: inline-block; width: 12px; height: 12px; background-color: #FF5F56; border-radius: 50%; margin-right: 6px;"></span>
    <span style="display: inline-block; width: 12px; height: 12px; background-color: #FFBD2E; border-radius: 50%; margin-right: 6px;"></span>
    <span style="display: inline-block; width: 12px; height: 12px; background-color: #27C93F; border-radius: 50%;"></span>
  </div>
<pre style="margin: 0; background: transparent; padding: 0; border: none; overflow: visible;">
<span style="color: #E5C07B;">interface</span> <span style="color: #61AFEF;">Developer</span> {
  <span style="color: #C678DD;">name</span>: <span style="color: #98C379;">string</span>;
  <span style="color: #C678DD;">location</span>: <span style="color: #98C379;">string</span>;
  <span style="color: #C678DD;">focus</span>: <span style="color: #98C379;">string</span>[];
  <span style="color: #C678DD;">passions</span>: <span style="color: #98C379;">string</span>[];
  <span style="color: #C678DD;">motto</span>: <span style="color: #98C379;">string</span>;
}
...
<span style="color: #E5C07B;">const</span> <span style="color: #61AFEF;">Dawood</span>: <span style="color: #61AFEF;">Developer</span> = {
  ...
  <span style="color: #C678DD;">passions</span>: [
    <span style="color: #56B6C2;">"Clean Architecture"</span>,
    <span style="color: #56B6C2;">"High-Performance APIs"</span>,
    <span style="color: #56B6C2;">"Scalable System Design"</span>
  ],
  <span style="color: #C678DD;">motto</span>: <span style="color: #56B6C2;">"Code. Create. Innovate. ⚡"</span>
};
</pre>
</div>
...
<div align="center">
  <img src="https://raw.githubusercontent.com/czl9707/gh-space-shooter/main/example.gif" alt="Space Shooter Animation" width="100%" />
</div>
